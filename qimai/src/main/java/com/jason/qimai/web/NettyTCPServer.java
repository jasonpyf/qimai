...
import com.jason.qimai.utils.Strings;
...
public abstract class NettyTCPServer {
    ...
    public void stop(Listener listener) {
        if (!serverState.compareAndSet(State.Started, State.Shutdown)) {
            if (listener != null) listener.onFailure(new RuntimeException("server was already shutdown."));
    ...
    private void createEpollServer(Listener listener) {
        ...
        if (bossGroup == null) {
            ...
            epollEventLoopGroup.setIoRatio(getBossIoRate());
        ...
        if (workerGroup == null) {
            ...
            epollEventLoopGroup.setIoRatio(getWorkerIoRate());
    ...
    protected String getBossThreadName() {
        return "BOSS-THREAD-NAME";
    }

    protected String getWorkThreadName() {
        return "WORK-THREAD-NAME";
    }
    
    protected int getBossIoRate() {
        return 100;
    }

    protected int getWorkerIoRate() {
        return 70;
    }
